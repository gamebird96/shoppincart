...
int resNo=3; //Stores Number of Column in a Row
  ...
  out.print("<h1>You Searched for:"+s+"</h1>");
out.print("<div class=\"row\">");
     // variables
        ...
        String msAccDB = "C:\\Users\\Samrat utta\\Documents\\ShoppingKart.accdb";
            ...
            resultSet = statement.executeQuery("SELECT * FROM item where keyword like '%"+s+"%'");
            ...
            while(resultSet.next()) {
                ...
                String res="<font color=#FFFFFF><div class=\"column\"><a href=\"product.jsp?ItmId="+item+"\"><img src=\"img\\"+type+"\\"+path+"\" height=\"200\" width=\"150\"></img><p><h4>" + name + "</h4></a><br><b>By " +seller + "</b><br>Rs:" + price + "<br>" + type + "</p><p><b><i>" + desc +"</i></b></p></div></font>";
                out.print(res);
                if(count%resNo==0)
                    out.print("</div><div class=\"row\"><br/><br/><br/><br/>&nbsp;&nbsp;");
            }
                //out.print("</div>");
               // out.print("<p><div class=\"row\" id=\"size\">No. Of Result:" + count +"</div></p>");
        }
